/**
 * @file Given a collection and a task return true if all promises resolve.
 ...
 * @param {Function} task Promise to be awaited for each key, called with (value, key).
 * @param {Object} options Optional overrides.
 * @param {Number} options.limit=Infinity Number of concurrently pending promises returned by mapper.
 * @returns {Boolean} true if all promises resolve otherwise throws an error
 */
